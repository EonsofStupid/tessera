...
// The validation logic is also implemented in backend/v3/domain/session_check_recovery_code.go.
// Keep both implementations in sync until this duplication is removed.
