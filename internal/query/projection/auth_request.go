...
import (
	...
	"github.com/EonsofStupid/tessera/internal/repository/authrequest"
...
func (p *authRequestProjection) reduceAuthRequestEnded(event eventstore.Event) (*handler.Statement, error) {
	...
	case *authrequest.SucceededEvent,
		*authrequest.FailedEvent:
		break
	default:
		return nil, zerrors.ThrowInvalidArgumentf(nil, "HANDL-ASF3h", "reduce.wrong.event.type %s", []eventstore.EventType{authrequest.SucceededType, authrequest.FailedType})
	}
