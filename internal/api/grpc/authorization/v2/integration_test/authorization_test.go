...
func TestServer_CreateAuthorization(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := Instance.Client.AuthorizationV2.CreateAuthorization(ctx, req)
			if tt.wantErr {
				require.Error(t, err)
				return
			}
...
func TestServer_UpdateAuthorization(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := Instance.Client.AuthorizationV2.UpdateAuthorization(ctx, req)
			if tt.wantErr {
				require.Error(t, err)
				return
			}
...
func TestServer_DeleteAuthorization(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := tt.args.prepare(t, req)
			afterPrepare := time.Now()
			got, err := Instance.Client.AuthorizationV2.DeleteAuthorization(ctx, req)
			if tt.wantErr {
				require.Error(t, err)
				return
			}
...
func TestServer_DeactivateAuthorization(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := tt.args.prepare(t, req)
			afterPrepare := time.Now()
			got, err := Instance.Client.AuthorizationV2.DeactivateAuthorization(ctx, req)
			if tt.wantErr {
				require.Error(t, err)
				return
			}
...
func TestServer_ActivateAuthorization(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			ctx := tt.args.prepare(t, req)
			afterPrepare := time.Now()
			got, err := Instance.Client.AuthorizationV2.ActivateAuthorization(ctx, req)
			if tt.wantErr {
				require.Error(t, err)
				return
			}
...
func createUserWithProjectGrantMembership(ctx context.Context, t *testing.T, instance *integration.Instance, projectID, grantID string) string {
	...
	require.EventuallyWithT(t, func(tt *assert.CollectT) {
		got, err := instance.Client.AuthorizationV2.ListAuthorizations(ctx, &authorization.ListAuthorizationsRequest{
			Filters: nil,
		})
