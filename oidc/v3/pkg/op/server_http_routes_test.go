...
import (
	...
	"github.com/shippinAI/nomen/oidc/v3/example/server/storage"
	...
	tests := []struct {
		...
		},
		{
			...
			contains: []string{
				...
				`,"sub":"id1","username":"test-user@localhost","name":"Test User","given_name":"Test","family_name":"User","locale":"de","preferred_username":"test-user@localhost","email":"test-user@nomen.test","email_verified":true}`,
			},
		},
		{
			name:   "user info",
			...
			wantCode: http.StatusOK,
			json:     `{"sub":"id1","name":"Test User","given_name":"Test","family_name":"User","locale":"de","preferred_username":"test-user@localhost","email":"test-user@nomen.test","email_verified":true}`,
		},
		{
			name:   "refresh token",
			method: http.MethodGet,
