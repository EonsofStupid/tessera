...
// Source: github.com/EonsofStupid/tessera/internal/notification/handlers (interfaces: Commands)
//
// Generated by this command:
//
//	mockgen -package mock -destination ./mock/commands.mock.go github.com/EonsofStupid/tessera/internal/notification/handlers Commands
//
...
import (
	...
	senders "github.com/EonsofStupid/tessera/internal/notification/senders"
	milestone "github.com/EonsofStupid/tessera/internal/repository/milestone"
	quota "github.com/EonsofStupid/tessera/internal/repository/quota"
...
func (m *MockCommands) BackChannelLogoutSent(ctx context.Context, id, oidcSessionID, instanceID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BackChannelLogoutSent", ctx, id, oidcSessionID, instanceID)
	ret0, _ := ret[0].(error)
	return ret0
}

// BackChannelLogoutSent indicates an expected call of BackChannelLogoutSent.
func (mr *MockCommandsMockRecorder) BackChannelLogoutSent(ctx, id, oidcSessionID, instanceID any) *gomock.Call {
