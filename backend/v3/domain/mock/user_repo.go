...
import (
	...
	domain "github.com/EonsofStupid/tessera/backend/v3/domain"
...
func (u *UserRepo) Human() domain.HumanUserRepository {
	return u.mock.Human()
}

func (u *UserRepo) Machine() domain.MachineUserRepository {
