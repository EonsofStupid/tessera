...
func TestServer_CreateProjectGrant(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := instance.Client.ProjectV2.CreateProjectGrant(tt.ctx, tt.req)
...
func TestServer_UpdateProjectGrant(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := instance.Client.ProjectV2.UpdateProjectGrant(tt.args.ctx, tt.args.req)
			if tt.wantErr {
				assert.Error(t, err)
				return
			}
...
func TestServer_DeleteProjectGrant(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := instance.Client.ProjectV2.DeleteProjectGrant(tt.ctx, tt.req)
			if tt.wantErr {
				assert.Error(t, err)
				return
			}
...
func TestServer_DeactivateProjectGrant(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := instance.Client.ProjectV2.DeactivateProjectGrant(tt.args.ctx, tt.args.req)
			if tt.wantErr {
				assert.Error(t, err)
				return
			}
...
func TestServer_ActivateProjectGrant(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := instance.Client.ProjectV2.ActivateProjectGrant(tt.args.ctx, tt.args.req)
			if tt.wantErr {
				assert.Error(t, err)
				return
			}
