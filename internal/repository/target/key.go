...
func (e *KeyAddedEvent) SetBaseEvent(base *eventstore.BaseEvent) { e.BaseEvent = *base }
func (e *KeyAddedEvent) Payload() any                            { return e }
func (e *KeyAddedEvent) UniqueConstraints() []*eventstore.UniqueConstraint {
	return nil
}

func NewKeyAddedEvent(ctx context.Context, aggregate *eventstore.Aggregate, keyID string, publicKey []byte, fingerprint string, expiration time.Time) *KeyAddedEvent {
	return &KeyAddedEvent{
		BaseEvent:      *eventstore.NewBaseEventForPush(ctx, aggregate, KeyAddedEventType),
		KeyID:          keyID,
		PublicKey:      publicKey,
...
func (e *KeyActivatedEvent) SetBaseEvent(base *eventstore.BaseEvent) { e.BaseEvent = *base }
func (e *KeyActivatedEvent) Payload() any                            { return e }
...
func (e *KeyDeactivatedEvent) SetBaseEvent(base *eventstore.BaseEvent) { e.BaseEvent = *base }
func (e *KeyDeactivatedEvent) Payload() any                            { return e }
...
func (e *KeyRemovedEvent) SetBaseEvent(base *eventstore.BaseEvent) { e.BaseEvent = *base }
func (e *KeyRemovedEvent) Payload() any                            { return e }
