...
func TestServer_CreateAdministrator(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := instance.Client.InternalPermissionV2.CreateAdministrator(tt.ctx, tt.req)
...
func TestServer_UpdateAdministrator(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := instance.Client.InternalPermissionV2.UpdateAdministrator(tt.ctx, tt.req)
			if tt.wantErr {
				assert.Error(t, err)
				return
			}
...
func TestServer_DeleteAdministrator(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := instance.Client.InternalPermissionV2.DeleteAdministrator(tt.ctx, tt.req)
			if tt.wantErr {
				assert.Error(t, err)
				return
			}
