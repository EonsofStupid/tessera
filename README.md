...
**Workspace ID:** `shippin.identity` · **Umbrella:** Shippin · **Status:** new,
contract-first

The identity and authorization service for the Shippin umbrella: who a member
is, which account they belong to, what they are entitled to, and the
short-lived tokens that carry all three to every other service.
