...
// Source: github.com/EonsofStupid/tessera/backend/v3/storage/database (interfaces: Pool,Connection,Row,Rows,Transaction)
//
// Generated by this command:
//
//	mockgen -typed -package dbmock -destination ./dbmock/database.mock.go github.com/EonsofStupid/tessera/backend/v3/storage/database Pool,Connection,Row,Rows,Transaction
//
